...
tags and GoReleaser archives, but it did not update a Homebrew formula.
...
`Formula/checksy.rb` in `flexdinesh/homebrew-tap`.
...
The formula has no runtime dependencies because the release archive contains the
